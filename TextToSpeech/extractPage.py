...
def SaveAudio():
    ...
    tts.save("webAudio1.mp3")
    print("Audio Saved-----")
    PlayAudio()


def PlayAudio():
    os.system("webAudio1.mp3")
#-------------------------------------------------------------------------------
# To play teh Audio
# ---------------------
def getAudioEngine():
...
pageSoup = extractPageContent("https://www.calibehr.com/life-at-calibehr.php")
...
#SaveAudio()  # To store the Audio file as mp3